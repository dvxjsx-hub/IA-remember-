...
function state(req, res) { try { res.json(roomService.get(req.query.playerId)); } catch (e) { fail(res, e); } }
function leave(req, res) { try { roomService.leave(req.body?.playerId); res.json({ ok: true }); } catch (e) { fail(res, e); } }
